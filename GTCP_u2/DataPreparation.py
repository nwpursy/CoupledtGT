...
def make_data(dataset_name,category,parentPath='../resource/preprocess/beijing',shuffle=False,sample_ratio=1,drop_last=False):
    ...
    dataLoader = DataLoader(dataset=dataset, batch_size=Const.batch_size, shuffle=shuffle,drop_last=drop_last)
    return dataLoader

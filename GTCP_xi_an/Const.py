...
# dataset_name='PM10_processed'
node_count = 12  # 随着输入数据修改

use_weather_cols=['datetime_LMT','Air Temperature','Dew Point Temperature','wind_x_kmph','wind_y_kmph']
non_wind_cols=['Air Temperature','Dew Point Temperature']
...
batch_size=256
epoch=80
log_path='../resource/result_models/xi_an/{}/in{}&out{}&step{}&offset{}'.format(

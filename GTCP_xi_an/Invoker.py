...
from GTCP_xi_an import Const,Framework,util
from GTCP_xi_an import DataPreparation as dp
from GTCP_xi_an.Train import train,test
...
if __name__ == '__main__':
    model_name = 'gtcp@hs{}$dm{}$alpha{}unshare$transcript{}'.format(
        Const.framework_hidden_size, Const.gaussian_PG_hidden_size,
        Const.intra_coupling_weight,0)
